...
export default function EmployeeDetailsPage() {
      ...
      <div className="sm:p-6 p-1 space-y-6">
        <div className="max-w-7xl">
          <div className="text-center py-12">
            ...
            <button
              onClick={() => router.back()}
              className="px-4 py-2 bg-cyan-50 border border-cyan-500/30 text-cyan-600 rounded-lg hover:bg-cyan-500/30 transition-colors"
            >
              Go Back
            </button>
          </div>
        ...
        {showPhotoModal && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 overflow-y-auto">
            <div className="min-h-full flex items-center justify-center p-4">
              <div className="bg-white border border-slate-200 rounded-xl shadow-xl max-w-md w-full my-8">
                {/* Modal Header */}
  ...
  const getPriorityColor = (priority: Task["priority"]) => {
    switch (priority) {
      case "urgent":
        return "bg-rose-50 text-rose-600 border-red-400/30";
      case "high":
        return "bg-orange-500/20 text-orange-600 border-orange-400/30";
      case "medium":
        return "bg-amber-50 text-amber-600 border-yellow-400/30";
      case "low":
        return "bg-emerald-50 text-emerald-600 border-green-400/30";
      default:
        return "bg-gray-500/20 text-slate-600 border-gray-400/30";
    }
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6 max-w-5xl">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-cyan-500/30 rounded-lg p-3">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-cyan-600/80 text-sm">Monthly Salary</p>
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-violet-600/10 border border-purple-500/30 rounded-lg p-3">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-violet-600/80 text-sm">Task Completion</p>
                <p className="text-xl font-bold text-violet-600 mt-1">
                  {completionRate.toFixed(0)}%
                </p>
                <p className="text-xs text-violet-600/60 mt-1">
          ...
          <div className="bg-gradient-to-br from-yellow-500/10 to-orange-600/10 border border-yellow-500/30 rounded-lg p-3">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-amber-600/80 text-sm">Total Incentives</p>
                    ...
                    <div>
                      ...
                      <div className="mt-2">
                        ...
                        <label
                          ...
                          className="inline-block px-3 py-1 bg-cyan-50 text-cyan-600 rounded-lg text-sm hover:bg-cyan-500/30 transition-colors cursor-pointer"
                        >
                          Change Photo
                        </label>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-slate-800 placeholder-slate-400 text-sm"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-slate-800 text-sm cursor-pointer"
                      >
                    ...
                    <div>
                      ...
                      <div className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-500 text-sm">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-slate-800 placeholder-slate-400 text-sm resize-none"
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <h4 className="text-md font-medium text-slate-700 border-b border-slate-200 pb-2">
                                ...
                                <div className="grid grid-cols-12 gap-4 items-center">
                                    ...
                                    <span
                                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                        incentive.type === "bonus"
                                          ? "bg-blue-50 text-blue-600 border border-blue-400/30"
                                          : incentive.type === "commission"
                                          ? "bg-violet-50 text-violet-600 border border-purple-400/30"
                                          : incentive.type === "achievement"
                                          ? "bg-amber-50 text-amber-600 border border-yellow-400/30"
                                          : "bg-emerald-50 text-emerald-600 border border-green-400/30"
                                      }`}
                                    >
                                      {incentive.type}
                                    </span>
                                  ...
                                  <div className="col-span-3">
                                    <div className="flex items-center space-x-2">
                                      <button
                                        className="flex items-center space-x-1 text-emerald-600 hover:text-emerald-600 text-sm transition-colors cursor-pointer disabled:opacity-50"
                      ...
                      >
                              ...
                              <span
                                className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium mt-1 ${
                                  document.category === "contract"
                                    ? "bg-rose-50 text-rose-600 border border-red-400/30"
                                    : document.category === "certificate"
                                    ? "bg-emerald-50 text-emerald-600 border border-green-400/30"
                                    : document.category === "performance"
                                    ? "bg-amber-50 text-amber-600 border border-yellow-400/30"
                                    : "bg-gray-500/20 text-slate-600 border border-gray-400/30"
                                }`}
                              >
                                {document.category}
                              </span>
                        ...
                        <div className="flex space-x-2">
                          <button
                            ...
                            className="flex-1 bg-blue-50 text-blue-600 hover:bg-blue-500/30 p-2 rounded-lg transition-colors cursor-pointer text-xs font-medium flex items-center justify-center space-x-1"
                          >
                          ...
                          <button
                            ...
                            className="bg-rose-50 text-rose-600 hover:bg-red-500/30 p-2 rounded-lg transition-colors cursor-pointer"
                          >
                            <Trash2 className="w-4 h-4" />
                          </button>
                        </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-slate-800 text-sm file:mr-4 file:py-1 file:px-2 file:rounded file:border-0 file:text-sm file:font-medium file:bg-cyan-50 file:text-cyan-600 hover:file:bg-cyan-500/30"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 text-slate-800 text-sm"
                      />
                    </div>
                  </div>
