        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          {filteredAccounts.map((account) => (
            <Link
              ...
              className="group"
            >
              <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/40 border border-slate-700/50 rounded-xl p-4 hover:from-slate-800/80 hover:to-slate-900/60 transition-all duration-300 hover:border-cyan-500/40 group-hover:transform group-hover:scale-[1.02] hover:shadow-xl hover:shadow-cyan-500/5 backdrop-blur-sm min-h-[160px] flex flex-col">
                {/* Account Header */}
                <div className="flex items-start justify-between mb-3 flex-shrink-0">
                  <div className="flex items-center space-x-2.5 flex-1 min-w-0">
                    <div className="p-1.5 bg-gradient-to-br from-cyan-500/15 to-cyan-600/10 border border-cyan-500/20 rounded-lg flex-shrink-0">
                  ...
                  <div className="flex items-center space-x-1.5 flex-shrink-0 ml-2">
                    ...
                    <div className="p-1 rounded-md bg-slate-700/50 group-hover:bg-cyan-500/10 transition-colors">
                      <Eye className="w-3 h-3 text-gray-400 group-hover:text-cyan-400 transition-colors" />
                    </div>
                  </div>
                </div>

                {/* Balance Section */}
                <div className="bg-slate-700/20 border border-slate-600/30 rounded-lg p-3 flex-1 flex items-center">
                  <div className="flex items-center justify-between w-full">
                    ...
                    <div className="text-right">
                      <div className="w-8 h-8 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 rounded-lg flex items-center justify-center">
                        {currency === 'USD' && <DollarSign className="w-3.5 h-3.5 text-cyan-400" />}
                        {currency === 'EUR' && <span className="text-cyan-400 text-sm font-bold">€</span>}
                        {currency === 'GBP' && <span className="text-cyan-400 text-sm font-bold">£</span>}
                        {currency === 'BDT' && <span className="text-cyan-400 text-xs font-bold">৳</span>}
                        {!['USD', 'EUR', 'GBP', 'BDT'].includes(currency) && <DollarSign className="w-3.5 h-3.5 text-cyan-400" />}
                      </div>
                    </div>
                  </div>
                </div>
          ...
          >
            <div className="bg-slate-800/30 border-2 border-dashed border-slate-600 hover:border-cyan-500/50 rounded-xl p-4 hover:bg-slate-800/50 transition-all duration-200 group-hover:transform group-hover:scale-[1.02] hover:shadow-lg hover:shadow-cyan-500/10 min-h-[160px] flex items-center justify-center">
              <div className="text-center">
                <div className="p-2.5 bg-gradient-to-br from-cyan-500/20 to-cyan-600/10 border border-cyan-500/30 rounded-lg w-10 h-10 mx-auto mb-2.5 flex items-center justify-center group-hover:bg-cyan-500/30 transition-colors">
                  <Plus className="w-4 h-4 text-cyan-400 group-hover:text-cyan-300 transition-colors" />
                </div>
                <h3 className="text-sm font-medium text-gray-300 group-hover:text-white transition-colors mb-1">
                  Create Account
                </h3>
