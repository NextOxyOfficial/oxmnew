  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Welcome Section */}
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl mb-8">
          <div className="px-6 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-gradient-to-r from-blue-500/20 to-blue-600/20 backdrop-blur-sm rounded-lg p-4 border border-blue-400/30">
                <h3 className="text-blue-300 text-sm font-medium mb-1">Username</h3>
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-purple-600/20 backdrop-blur-sm rounded-lg p-4 border border-purple-400/30">
                <h3 className="text-purple-300 text-sm font-medium mb-1">Email</h3>
              ...
              <div className="bg-gradient-to-r from-green-500/20 to-green-600/20 backdrop-blur-sm rounded-lg p-4 border border-green-400/30">
                ...
                <p className="text-white font-semibold">{user?.first_name || 'Not provided'}</p>
              </div>
              <div className="bg-gradient-to-r from-orange-500/20 to-orange-600/20 backdrop-blur-sm rounded-lg p-4 border border-orange-400/30">
                <h3 className="text-orange-300 text-sm font-medium mb-1">Last Name</h3>
                <p className="text-white font-semibold">{user?.last_name || 'Not provided'}</p>
              </div>
            </div>
          </div>
        </div>
