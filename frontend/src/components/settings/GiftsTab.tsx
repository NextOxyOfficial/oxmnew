...
export default function GiftsTab({ gifts, setGifts, showNotification, loading }: GiftsTabProps) {
  ...
  const handleDeleteClick = (gift: Gift) => {
    setDeleteModal({ isOpen: true, gift });
  };
  ...
  const handleDeleteConfirm = () => {
    if (deleteModal.gift) {
      deleteGift(deleteModal.gift.id);
    }
  };
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-300">
                        ...
                        <span className="font-semibold text-white">"{deleteModal.gift?.name}"</span>? 
