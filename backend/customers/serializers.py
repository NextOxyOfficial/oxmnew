...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Customer
        fields = [
            'id', 'name', 'email', 'phone', 'address', 'status', 'notes',
            'total_orders', 'total_spent', 'last_order_date', 'active_gifts_count',
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'tax_amount', 'notes', 'delivery_address', 'expected_delivery_date',
...
class CustomerGiftSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomerGift
        fields = [
            'id', 'customer', 'customer_name', 'gift', 'gift_name',
            'value', 'status', 'description', 'expiry_date',
            'used_date', 'used_in_order', 'created_at', 'updated_at'
        ]
        read_only_fields = ['created_at', 'updated_at']
...
class CustomerAchievementSerializer(serializers.ModelSerializer):
    ...
    achievement_type = serializers.CharField(
        source='achievement.type', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            'id', 'customer', 'customer_name', 'achievement', 'achievement_name',
            'achievement_type', 'achievement_points', 'earned_date', 'notes'
        ]
...
class DuePaymentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'amount', 'payment_type', 'due_date', 'status', 'notes',
...
class TransactionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'customer', 'customer_name', 'order', 'order_number',
            'due_payment', 'transaction_type', 'amount', 'payment_method',
            'reference_number', 'notes', 'notify_customer', 'sms_sent',
            'created_at', 'updated_at'
        ]
        read_only_fields = ['created_at', 'updated_at']
...
class SMSLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SMSLog
        fields = [
            'id', 'customer', 'customer_name', 'message', 'phone_number',
            'status', 'order', 'transaction', 'due_payment',
            'sms_service_response', 'sent_at', 'created_at'
        ]
...
class CustomerDetailSerializer(CustomerSerializer):
    ...
    customer_achievements = CustomerAchievementSerializer(
    ...
    class Meta(CustomerSerializer.Meta):
        fields = CustomerSerializer.Meta.fields + [
            'orders', 'customer_gifts', 'customer_achievements',
            'customer_levels', 'due_payments', 'transactions'
        ]
...
class CustomerStatsSerializer(serializers.Serializer):
    ...
    top_customers = CustomerSerializer(many=True)
