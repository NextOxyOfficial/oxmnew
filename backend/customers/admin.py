...
class CustomerAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Metadata",
            {"fields": ("user", "created_at", "updated_at"), "classes": ("collapse",)},
        ),
    )
...
class CustomerGiftAdmin(admin.ModelAdmin):
    list_display = ["customer", "gift", "value", "status", "expiry_date", "created_at"]
...
class CustomerLevelAdmin(admin.ModelAdmin):
    list_display = ["customer", "level", "is_current", "assigned_date", "assigned_by"]
...
class DuePaymentAdmin(admin.ModelAdmin):
    list_display = ["customer", "order", "payment_type", "amount", "due_date", "status"]
...
class SMSLogAdmin(admin.ModelAdmin):
    list_display = ["customer", "phone_number", "status", "sent_at", "created_at"]
