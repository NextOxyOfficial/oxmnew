...
class EmployeeAdmin(admin.ModelAdmin):
    ...
    list_filter = ["status", "department", "role", "hiring_date", "user"]
    search_fields = ["name", "email", "employee_id", "role", "department"]
    readonly_fields = ["tasks_assigned", "tasks_completed", "created_at", "updated_at"]
    fieldsets = (
        (
            "Basic Information",
...
class IncentiveAdmin(admin.ModelAdmin):
    list_display = ["title", "employee", "type", "amount", "status", "date_awarded"]
